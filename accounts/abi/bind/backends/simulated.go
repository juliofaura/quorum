...
var errGasEstimationFailed = errors.New("gas required exceeds allowance or always failing transaction (in errGasEstimationFailed declaration in accounts/abi/bind/backends/simulated.go")
